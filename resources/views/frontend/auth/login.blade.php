...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>{{ $option->getByKey('site_name') }} | Account - Sign In</title>
    <meta name="description" content="{{ $option->getByKey('site_description') ?? 'Your site description here.' }}">
    <meta name="keywords"
            ...
            <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
                ...
                <header class="navbar px-0 pb-4 mt-n2 mt-sm-0 mb-2 mb-md-3 mb-lg-4">
                    <a href="{{ url('/') }}" class="navbar-brand pt-0">
                        ...
                        {{ $option->getByKey('site_name') ?? 'Site Name' }}
                    </a>
                </header>
                ...
                <div class="alert alert-danger alert-dismissible mb-4" role="alert">
                    <i class="ci-info fs-base me-2"></i>
                    {{ session('error') }}
                ...
                <div class="alert alert-success alert-dismissible mb-4" role="alert">
                    <i class="ci-check fs-base me-2"></i>
                    {{ session('success') }}
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                @endif
                ...
                <!-- Form -->
                <form action="{{ route('web.auth.doLogin') }}" method="POST">
