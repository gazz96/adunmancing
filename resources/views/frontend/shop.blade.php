...
@section('content')
    ...
    <main class="content-wrapper">
        <div class="container pb-5 mb-2 mb-sm-3 mb-lg-4 mb-xl-5">
            ...
            <!-- Page title -->
            <h1 class="h3 position-relative pb-sm-2 pb-md-3" style="z-index: 1021">Shop</h1>
                ...
                <div class="col">
                    <div class="animate-underline mb-sm-2">
                        ...
                        <a class="ratio ratio-1x1 d-block mb-3" href="{{ $product->permalink }}">
                            ...
                            @endif
                            <img src="{{$product->featured_image_url}}" class="hover-effect-target opacity-100"
                                alt="{{$product->name}}">
                        ...
                        <div class="h6">{{ $product->price_label}}
                            @if($product->compare_price)
                            <span class="text-body-secondary text-decoration-line-through ms-1">{{ $product->compare_price_label }}</span>
                            @endif
                        </div>
...
@section('footer_scripts')
    ...
    <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="shopFilters" tabindex="-1"
        ...
        <div class="offcanvas-body pt-0">
            ...
            <!-- Sort by -->
            <select class="form-select form-select-lg form-select-flush text-body-emphasis fw-medium py-3 px-0"
                id="fil"
                data-select='{
          "classNames": {
            ...
            <div class="accordion" id="filters">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-collapse collapse" id="categoryFilter" aria-labelledby="headingCategory"
                        data-bs-parent="#filters">
                        <div class="accordion-body d-flex flex-column gap-2 px-1">
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="living-room-2" checked
                                    onclick="updateFilterCount('categoryCount-2')" data-count-id="categoryCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="bedroom-2" checked
                                    onclick="updateFilterCount('categoryCount-2')" data-count-id="categoryCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="kitchen-2"
                                    onclick="updateFilterCount('categoryCount-2')" data-count-id="categoryCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="office-2"
                                    onclick="updateFilterCount('categoryCount-2')" data-count-id="categoryCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="lighting-2" checked
                                    onclick="updateFilterCount('categoryCount-2')" data-count-id="categoryCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="decoration-2"
                                    onclick="updateFilterCount('categoryCount-2')" data-count-id="categoryCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="accessories-2" checked
                                    onclick="updateFilterCount('categoryCount-2')" data-count-id="categoryCount-2">
                ...
                <div class="accordion-item">
                    <h6 class="accordion-header" id="headingType">
                        <button type="button" class="accordion-button fw-medium collapsed" data-bs-toggle="collapse"
                            data-bs-target="#typeFilter" aria-expanded="false" aria-controls="typeFilter">
                            <span class="d-flex align-items-end">
                                Type
                    ...
                    <div class="accordion-collapse collapse" id="typeFilter" aria-labelledby="headingType"
                        data-bs-parent="#filters">
                        <div class="accordion-body d-flex flex-column gap-2 px-1">
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="armchair-2"
                                    onclick="updateFilterCount('typeCount-2')" data-count-id="typeCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="sofa-2"
                                    onclick="updateFilterCount('typeCount-2')" data-count-id="typeCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="ottoman-2"
                                    onclick="updateFilterCount('typeCount-2')" data-count-id="typeCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="bench-2"
                                    onclick="updateFilterCount('typeCount-2')" data-count-id="typeCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="bed-2"
                                    onclick="updateFilterCount('typeCount-2')" data-count-id="typeCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="lamp-2"
                                    onclick="updateFilterCount('typeCount-2')" data-count-id="typeCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="stool-2"
                                    onclick="updateFilterCount('typeCount-2')" data-count-id="typeCount-2">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-collapse collapse" id="colorFilter" aria-labelledby="headingColor"
                        data-bs-parent="#filters">
                        <div class="accordion-body d-flex flex-column gap-2 px-1">
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="emerald-2"
                                    onclick="updateFilterCount('colorCount-2')" data-count-id="colorCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="dark-gray-2"
                                    onclick="updateFilterCount('colorCount-2')" data-count-id="colorCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="light-gray-2"
                                    onclick="updateFilterCount('colorCount-2')" data-count-id="colorCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="brown-2"
                                    onclick="updateFilterCount('colorCount-2')" data-count-id="colorCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="blue-2"
                                    onclick="updateFilterCount('colorCount-2')" data-count-id="colorCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="green-2"
                                    onclick="updateFilterCount('colorCount-2')" data-count-id="colorCount-2">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="beige-2"
                                    onclick="updateFilterCount('colorCount-2')" data-count-id="colorCount-2">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-collapse collapse" id="sizeFilter" aria-labelledby="headingSize"
                        data-bs-parent="#filters">
                        <div class="accordion-body d-flex flex-column gap-2 px-1">
                            <div class="fs-sm fw-semibold text-body-emphasis pb-2">Width</div>
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="width-1"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="width-2"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="width-3"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="width-4"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="width-5"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="height-1"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="height-2"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="height-3"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="height-4"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="height-5"
                                    onclick="updateFilterCount('sizeCount')" data-count-id="sizeCount">
                ...
                <div class="accordion-item">
                    <h6 class="accordion-header" id="headingMaterial">
                        <button type="button" class="accordion-button fw-medium collapsed" data-bs-toggle="collapse"
                            data-bs-target="#materialFilter" aria-expanded="false" aria-controls="materialFilter">
                            <span class="d-flex align-items-end">
                                Material
                    ...
                    <div class="accordion-collapse collapse" id="materialFilter" aria-labelledby="headingMaterial"
                        data-bs-parent="#filters">
                        <div class="accordion-body d-flex flex-column gap-2 px-1">
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="fabric"
                                    onclick="updateFilterCount('materialCount')" data-count-id="materialCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="wood"
                                    onclick="updateFilterCount('materialCount')" data-count-id="materialCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="leather"
                                    onclick="updateFilterCount('materialCount')" data-count-id="materialCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="metal"
                                    onclick="updateFilterCount('materialCount')" data-count-id="materialCount">
                            ...
                            <div class="form-check m-0">
                                <input type="checkbox" class="form-check-input fs-base" id="plastic"
                                    onclick="updateFilterCount('materialCount')" data-count-id="materialCount">
