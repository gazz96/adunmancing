    ...
    <main class="content-wrapper">
        ...
        <section class="bg-body-tertiary min-vh-100 d-flex align-items-center overflow-hidden"
            ...
            <div class="container h-100 py-5 my-md-2 my-lg-3 my-xl-4 mb-xxl-5">
                <h1 class="display-4 text-center mx-auto mb-4" style="max-width: 680px">Peralatan Memancing yang Anda Butuhkan
                </h1>
                <div class="row align-items-center justify-content-center gx-3 gx-sm-4 mb-3 mb-sm-4">
                    ...
                    <div class="col-lg-1 col-xl-2 d-none d-lg-flex justify-content-end">
                        <div class="position-relative user-select-none" style="width: 262px">
                            <span
                                class="position-absolute top-0 start-0 w-100 h-100 bg-white opacity-50 rounded-circle d-none-dark"></span>
                            <span
                            ...
                            <div class="swiper position-relative z-2 opacity-60 rounded-circle pe-none" id="thumbsPrev"
                                data-swiper='{
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    $slidersPrevs = $sliders;
                                    $temp = $slidersPrevs->pop();
                                    $slidersPrevs->prepend($temp);
                                    @endphp 
                                    @foreach ($slidersPrevs as $slidersPrev)
                                        <div class="swiper-slide">
                                            <div class="ratio ratio-1x1">
                                                <img src="{{ $slidersPrev->featured_image_url }}" alt="{{ $slidersPrev->name }}">
                                            </div>
                                        </div>
                                    @endforeach
                    ...
                    <div class="col-sm-10 col-lg-8 col-xl-6 order-3">
                        <div class="swiper user-select-none rounded-pill"
                            data-swiper='{
                            "loop": true,
                            "grabCursor": true,
                            "speed": 600,
                            ...
                            <div class="swiper-wrapper">
                                ...
                                @foreach ($sliders as $slider)
                                    <div class="swiper-slide" data-swiper-binded="#description{{ $slider->id }}">
                                        <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                                            <img src="{{ $slider->featured_image_url }}" alt="{{ $slider->name }}">
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <!-- Next button -->
                    <div
                        class="col-auto col-sm-1 order-2 order-sm-3 order-lg-4 d-flex align-items-center justify-content-center">
                        <button type="button"
                    ...
                    <div class="col-lg-1 col-xl-2 order-lg-5 d-none d-lg-block">
                        <div class="position-relative user-select-none" style="width: 262px">
                            ...
                            <span
                                class="position-absolute top-0 start-0 w-100 h-100 bg-white rounded-circle d-none-dark d-none d-block-dark"
                                style="opacity: .05"></span>
                            <div class="swiper position-relative z-2 opacity-60 rounded-circle pe-none" id="thumbsNext"
                                data-swiper='{
                                    "allowTouchMove": false,
                                    "loop": true,
                                    "effect": "coverflow",
                                ...
                                <div class="swiper-wrapper">
                                    @php 
                                    $slidersNext = $sliders;
                                    $temp = $slidersNext->shift();
                                    $slidersNext->push($temp);
                                    @endphp 
                                    @foreach ($slidersNext as $slider)
                                        <div class="swiper-slide">
                                            <div class="ratio ratio-1x1">
                                                <img src="{{ $slider->featured_image_url }}" alt="{{ $slider->name }}">
                                            </div>
                    ...
                    <div class="swiper-wrapper">
                        @foreach ($sliders as $slider)
                            <div class="swiper-slide bg-body-tertiary text-center">
                                <h3 class="text-secondary-emphasis fs-base fw-normal mb-2">{{ $slider->name }}</h3>
                                <p class="h4 mb-4">{{ $slider->price_label }}</p>
                                <a class="btn btn-lg btn-dark rounded-pill"
                                    href="{{ route('frontend.product-detail', $slider) }}">
                                    Shop now
                                ...
                                <div class="category-card-body-x">
                                    <a class="d-block text-decoration-none"
                                        ...
                                        <div class="bg-body-tertiary rounded-pill mb-3 mx-auto" style="max-width: 164px">
                                            <div class="ratio ratio-1x1">
                                                <img src="{{ asset('storage/' . $productCategory->icon) }}"
                                                    class="rounded-pill" alt="Image">
                                            </div>
                                        </div>
                                        <h3 class="category-card-title h6 text-truncate">{{ $productCategory->name }}
                                        </h3>
                                    </a>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="animate-underline">
                                <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3"
                                    ...
                                    <img src="assets/img/shop/furniture/04.png" class="hover-effect-target opacity-100"
                                        alt="Product">
                        ...
                        <div class="swiper-slide">
                            <div class="animate-underline">
                                <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3"
                                    href="shop-product-furniture.html">
                                    <img src="assets/img/shop/furniture/05.png" class="hover-effect-target opacity-100"
                                        alt="Product">
                        ...
                        <div class="swiper-slide">
                            <div class="animate-underline">
                                <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3"
                                    ...
                                    <img src="assets/img/shop/furniture/06.png" class="hover-effect-target opacity-100"
                                        alt="Product">
                                ...
                                <div class="h6">$140.00 <del class="fs-sm fw-normal text-body-tertiary">$160.00</del>
                                </div>
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-dark w-100 rounded-pill px-3">Add to
                                        cart</button>
                        ...
                        <div class="swiper-slide">
                            <div class="animate-underline">
                                <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3"
                                    href="shop-product-furniture.html">
                                    <img src="assets/img/shop/furniture/08.png" class="hover-effect-target opacity-100"
                                        alt="Product">
                        ...
                        <div class="swiper-slide">
                            <div class="animate-underline">
                                <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3"
                                    href="shop-product-furniture.html">
                                    <img src="assets/img/shop/furniture/02.png" class="hover-effect-target opacity-100"
                                        alt="Product">
                        ...
                        <div class="swiper-slide">
                            <div class="animate-underline">
                                <a class="hover-effect-opacity ratio ratio-1x1 d-block mb-3"
                                    href="shop-product-furniture.html">
                                    <img src="assets/img/shop/furniture/07.png" class="hover-effect-target opacity-100"
                                        alt="Product">
        ...
        <section class="container pb-5 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
            <div class="row row-cols-1 row-cols-md-3 gy-3 gy-sm-4 gx-2 gx-lg-4 mb-xxl-3">
                <div class="col text-center">
                    <svg class="d-block text-dark-emphasis mx-auto mb-3 mb-lg-4" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p class="fs-sm px-5 mb-md-0">Decorate your space with eco-friendly furniture with low VOCs,
                ...
                <div class="col text-center">
                    ...
                    <p class="fs-sm px-5 mb-md-0">We choose raw materials from the best manufacturers, so our
                        furniture and decor are of the highest quality at the best prices.</p>
                </div>
                <div class="col text-center">
                    <svg class="d-block text-dark-emphasis mx-auto mb-3 mb-lg-4" xmlns="http://www.w3.org/2000/svg"
                        width="64" height="64" viewBox="0 0 64 64" fill="currentColor">
                    ...
                    <p class="fs-sm px-5 mb-md-0"> We will deliver to your door anywhere in the world. If you're not
                        100% satisfied, let us know within 30 days and we'll solve the problem.</p>
                </div>
            </div>
        </section>
            ...
            <section class="container">
                <div class="row row-cols-1 row-cols-md-2 g-0 overflow-hidden rounded-5">
                    ...
                    <div class="col position-relative">
                        ...
                        <img src="assets/img/home/furniture/featured-product.png"
                            class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-1" alt="Image">
                        <div class="position-absolute start-0 bottom-0 d-flex align-items-end w-100 h-100 z-2 p-4">
                            <a class="btn btn-lg btn-light rounded-pill m-md-2"
                                href="https://www.youtube.com/watch?v=Z1xX1Kt9NkU" data-glightbox data-gallery="video">
                    ...
                    <div class="col d-flex align-items-center justify-content-center bg-dark py-5 px-4 px-md-5"
                        ...
                        <div class="text-center py-md-2 py-lg-3 py-xl-4" style="max-width: 400px">
                            ...
                            <h2 class="h4 pb-lg-2 pb-xl-0 mb-4 mb-xl-5">Scandinavian green chair with wooden legs 60x100
                                cm</h2>
                            <div class="d-inline-flex pb-lg-2 pb-xl-0 mb-4 mb-xl-5">
                                <img src="assets/img/home/furniture/featured-product-thumbnail.jpg" class="rounded"
                                    width="162" alt="Product">
                            </div>
                            <div class="h3 pb-2 pb-md-3">$357.00</div>
                            <a class="btn btn-lg btn-outline-light rounded-pill" href="shop-product-furniture.html">Shop
                                now</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row gy-5 mb-xxl-3">
                ...
                <article class="col-md-6">
                    ...
                    <div class="pt-4">
                        ...
                        <h3 class="h5 mb-3">
                            <a class="hover-effect-underline" href="#!">Decorate your home for the festive
                                season in 3 easy steps</a>
                        </h3>
                        <div class="nav align-items-center gap-2 fs-xs">
                            <a class="nav-link text-body-secondary fs-xs fw-normal p-0" href="#!">Ava
                                Johnson</a>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 gy-5">
                        ...
                        <article class="col">
                            ...
                            <div class="pt-4">
                                ...
                                <h3 class="h6 mb-3">
                                    <a class="hover-effect-underline" href="#!">Transform your living space
                                        with these chic interior design tips</a>
                                </h3>
                                <div class="nav align-items-center gap-2 fs-xs">
                        ...
                        <article class="col">
                            ...
                            <div class="pt-4">
                                ...
                                <h3 class="h6 mb-3">
                                    <a class="hover-effect-underline" href="#!">Furnishing your space: a guide
                                        to choosing the perfect furniture pieces</a>
                                </h3>
                                <div class="nav align-items-center gap-2 fs-xs">
